...
FILE_SETS = {
    "public-assets": {
        "/pet_expert_shilang-2026.08.18.5.bin": (
            Path("/roles/pet_expert_shilang-2026.08.18.5.bin"),
            "application/octet-stream",
            PUBLIC_CACHE,
        ),
        "/pet_expert_shilang-2026.08.18.4.bin": (
            Path("/roles/pet_expert_shilang-2026.08.18.4.bin"),
            "application/octet-stream",
            PUBLIC_CACHE,
        ),
        ...
        "/pet_expert_shilang-2026.08.17.1.bin": (
            Path("/roles/pet_expert_shilang-2026.08.17.1.bin"),
            "application/octet-stream",
            PUBLIC_CACHE,
        ),
        "/cheese_cat-2026.08.17.1.bin": (
            Path("/roles/cheese_cat-2026.08.17.1.bin"),
            "application/octet-stream",
            PUBLIC_CACHE,
        ),
        "/beta_dog-2026.08.17.1.bin": (
            Path("/roles/beta_dog-2026.08.17.1.bin"),
            "application/octet-stream",
            PUBLIC_CACHE,
        ),
    ...
    "public-avatars": {
        "/pet_expert_shilang_idle-2026.08.18.5.png": (
            Path("/avatars/pet_expert_shilang_idle_v5.png"),
            "image/png",
            PUBLIC_CACHE,
        ),
    ...
    "internal": {
        "/nezuko_proto-2026.08.17.1.bin": (
            Path("/roles/nezuko_proto-2026.08.17.1.bin"),
            "application/octet-stream",
            "no-store",
        ),
